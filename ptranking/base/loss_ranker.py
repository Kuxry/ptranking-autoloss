...
class loss_ranker(NeuralRanker):
    '''
    ...
    '''
    def __init__(self, id='loss_ranker', model_path="./model/loss_ranker.pt" ,sf_para_dict=None, weight_decay=1e-3, gpu=False, device=None):
        super(loss_ranker, self).__init__(id=id, sf_para_dict=sf_para_dict, weight_decay=weight_decay, gpu=gpu, device=device)
